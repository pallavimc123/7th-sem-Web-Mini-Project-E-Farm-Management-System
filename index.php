	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2>E-Farm Management System</h2>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Agro Culture Fam<span>New Delhi</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">9632859566</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:white">agroculture.com</a></p>
			</div>
		</div>
								...
								<div class="row uniform">
									<p>
                                       ...
                                       <div class="2u 12u$(small)">
                                          ...
                                          <label for="1">Farmer</label>
                                       </div>
                                      <div class="3u 12u$(small)">
                                          <input type="radio" id="2" name="year" value="2">
                                          <label for="2">Buyer</label>
                                       </div>    
					           	</div>    
								<div class="row uniform">
									<div class="3u 12u$(small)">
